...
Project documentation follows [Diátaxis](https://diataxis.fr): each document
serves one reader need and lives in the directory for that need. A directory
exists once it holds a document.

- `docs/tutorials/`: guided lessons for a newcomer, one path through.
